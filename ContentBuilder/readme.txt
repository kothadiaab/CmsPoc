...
To control "Embed original image" checkbox on Image dialog: 
	- embedOriginalChecked (true/false. default: false): to check the checkbox by default
	- hideEmbedOriginal (true/false. default: false): to hide the checkbox

	$("#contentarea").contentbuilder({
			embedOriginalChecked: true,
